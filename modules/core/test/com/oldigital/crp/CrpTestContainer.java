...
public class CrpTestContainer extends TestContainer {

    public CrpTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/oldigital/crp/app.properties",
    ...
    public static class Common extends CrpTestContainer {

        public static final CrpTestContainer.Common INSTANCE = new CrpTestContainer.Common();
