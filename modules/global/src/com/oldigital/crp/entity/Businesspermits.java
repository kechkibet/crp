...
import com.oldigital.crp.entity.enums.PermitStatus;

@DesignSupport("{'imported':true}")
@NamePattern("%s|id")
@Table(name = "businesspermits")
@Entity(name = "crp$Businesspermits")
public class Businesspermits extends BaseIntIdentityIdEntity implements Versioned, SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = 8093746693466486099L;
    ...
    public PermitStatus getStatus() {
        return status == null ? null : PermitStatus.fromId(status);
    }
