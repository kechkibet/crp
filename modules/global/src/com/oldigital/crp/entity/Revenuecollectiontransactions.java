...
@Entity(name = "crp$Revenuecollectiontransactions")
public class Revenuecollectiontransactions extends BaseIntIdentityIdEntity implements Versioned, SoftDelete, Updatable, Creatable {
    private static final long serialVersionUID = 3234186278517497740L;
    ...
    @Column(name = "`reconFileID`")
    protected Integer reconFileID;
